                                                ...
                                                <div id="collapseOne" class="collapse show" data-parent="#accordion">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="my-3">
                                                            ...
                                                            <input type="text" name="brandname" id="brandname" required class="form-control">
                                                        </div>
                                                        ...
                                                        <div class="my-3">
                                                            ...
                                                            <input type="date" name="expirydate" id="expirydate" required class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div id="collapseTwo" class="collapse" data-parent="#accordion">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="my-3">
                                                            ...
                                                            <input type="text" name="packaging" id="packaging" required class="form-control">
                                                        </div>

                                                        <div class="my-3">
                                                            <label for="dimention" class="form-label">Enter Dimention Details</label>
                                                            <input type="text" name="dimention" id="dimention" required class="form-control">
                                                        </div>
                                                        ...
                                                        <div class="my-3">
                                                            ...
                                                            <textarea name="productdescription" id="productdescription" required class="form-control"></textarea>
                                                        </div>
                                                        ...
                                                        <div class="my-3">
                                                            ...
                                                            <input type="text" name="handling" id="handling" required class="form-control">
                                                        </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseFour" class="collapse" data-parent="#accordion">
                                                    ...
                                                    <div class="my-3">
                                                            ...
                                                            <input type="file" name="media[]" id="media" required class="form-control" accept=".jpg, .jpeg, .png, .mp4" multiple>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php
    if(isset($_POST["addProcess"])){
        ...
        $productid = $products->addNewProdcut($productname, $productcategory, $brandname, $manufacturedate, $expirydate, $material, $packaging, $dimention, $color, $weight, $productdescription, $country, $handling, $sku, $price, $discount, $warranty, $minimumorder);

        //echo "New Product ID is $prodcutid";
        ...
        if($productid > 0){
            ...
            <strong>Success : </strong> New Product $productname Added in Database with $validfile Files Uploaded and $invalidfile Files are failed to upload.
            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
            <span aria-hidden='true'>&times;</span></button></div>";

        }else{
            $_SESSION["msg"] = "<div class='alert alert-danger alert-dismissible'>
            <strong>Error : </strong> Error while uploading new product
            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
            <span aria-hidden='true'>&times;</span></button></div>";
        }

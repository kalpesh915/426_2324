                                ...
                                <div class="card-body">
                                    ...
                                    <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="my-3">
                                            ...
                                            <input type="text" name="jobdescription" id="jobdescriptrion" required class="form-control">
                                        </div>

                                        <div class="my-3">
                                            <label for="photo" class="form-label">Enter Member Photo </label>
                                            <input type="file" name="photo" id="photo" required class="form-control" accept=".jpg">
                                        </div>
                                        ...
                                        <div class="my-3">
                                            ...
                                            <input type="email" name="teamemail" id="teamemail"  class="form-control">
                                        </div>

                                        <div class="my-3">
                                            <label for="teamphone" class="form-label">Enter Member Phone Number </label>
                                            <input type="text" name="teamphone" id="teamphone"  class="form-control">
                                        </div>
...
<?php
    if(isset($_POST["addProcess"])){
        ...
        if($photo["type"] == "image/jpg" || $photo["type"] == "image/jpeg"){
            ...
            $expericence = $team->filterData($_POST["experience"]);
            ...
            $team->addNewTeamMember($membername, $designation, $expericence, $jobdescription, $destination, $teamfacebook, $teamtwitter, $teaminstagram, $teamlinkedin, $teamemail, $teamphone);

            
            $_SESSION["msg"] = "<div class='alert alert-success alert-dismissible'>
            <strong>Success : </strong> New Team Member $membername Added in team
            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
            <span aria-hidden='true'>&times;</span></button></div>";


            $team->logWriter($adminemail, "New Team Member $membername Added in team");
        }else{

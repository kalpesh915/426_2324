<?php
    ...
    if(isset($_SESSION["validateuser"])){
        $resetemail = $_SESSION["validateuser"];
    }else{
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">Enter OTP Received in <b><?= $resetemail; ?> </b> Email Address</p>
                                    </div>
                                    <?php
...
<?php
    ...
    if(isset($_POST["checkProcess"])){
        $otptext = $reset->filterData($_POST["otptext"]);
        //echo $otptext;

        if($reset->validateOTP($resetemail, $otptext)){
